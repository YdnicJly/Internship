...
<head>
  ...
  <title>Evaluation & Final Report - Diskominfo Internship</title>
    ...
    <div>
      ...
      <ul class="nav flex-column gap-1">
        ...
        <li><a href="{{ route('student.journal') }}" class="nav-link"><i class="bi bi-journal-text me-2"></i> My
            Journal</a></li>
        <li><a href="{{ route('student.evaluation') }}" class="nav-link active"><i class="bi bi-award me-2"></i>
            Evaluation</a></li>
  ...
  <div class="content">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white mb-4 rounded shadow-sm">
      <div class="container-fluid">
        <span class="navbar-brand mb-0 h5">Evaluation & Final Report</span>
    ...
    <div class="card p-4 mb-4">
      <h5 class="mb-3"><i class="bi bi-upload me-2 text-primary"></i> Upload Final Report</h5>
      @if ($finalReport)
        <div class="alert alert-success d-flex justify-content-between align-items-center">
          <div>
            <i class="bi bi-file-earmark-check-fill me-2"></i>
            <strong>Uploaded:</strong> {{ basename($finalReport->file_path) }} <br>
            <small class="text-muted">Submitted on {{ $finalReport->created_at->format('d M Y, H:i') }}</small>
          </div>
        ...
        <form action="{{ route('finalreport.store') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="row g-3 align-items-center">
            ...
            <div class="col-md-4 text-end">
              <button type="submit" class="btn btn-primary"><i class="bi bi-cloud-arrow-up me-1"></i> Upload
                Report</button>
            </div>
          </div>
        </form>
    ...
    <!-- Evaluation Results -->
    <div class="card p-4 mb-4">
      <h5 class="mb-3"><i class="bi bi-clipboard-data me-2 text-success"></i> Evaluation Results</h5>
      @if ($evaluation)
    ...
    <!-- Certificate -->
    <div class="card p-4">
      <h5 class="mb-3"><i class="bi bi-award-fill me-2 text-warning"></i> Internship Certificate</h5>
      @if ($certificate)
        <div class="d-flex justify-content-between align-items-center alert alert-light border">
          <div>
            ...
            <small class="text-muted">Issued on {{ $certificate->created_at->format('d M Y') }}</small>
          </div>
