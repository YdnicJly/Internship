...
<head>
  ...
  <title>Interview - Diskominfo Internship</title>
  ...
  <div class="sidebar p-3">
    <div>
      ...
      <ul class="nav flex-column gap-1">
        ...
        <li><a href="{{ route('admin.applicants') }}" class="nav-link"><i class="bi bi-people me-2"></i> Applicants</a>
        </li>
  ...
  <div class="content">
    <nav class="navbar navbar-expand-lg navbar-light bg-white mb-4 rounded shadow-sm">
      <div class="container-fluid">
        <span class="navbar-brand mb-0 h5">Interview Management</span>
    ...
    <div class="card p-4">
      <div class="d-flex justify-content-between align-items-center mb-4">
        <h5 class="mb-0"><i class="bi bi-calendar-check text-primary me-2"></i> All Interview Schedule</h5>
      </div>
...
<table id="interviewsTable" class="table table-hover align-middle">
  ...
  <tbody>
        ...
        <td class="text-end">
          ...
          <form action="{{ route('admin.interviews.destroy', $interview->id) }}" method="POST" class="d-inline">
            ...
            <button type="submit" class="btn btn-sm btn-outline-danger"
              onclick="return confirm('Delete this interview schedule?')">
    ...
    @empty
      <tr>
        <td colspan="6" class="text-center text-muted py-4">No interview schedules found.</td>
      </tr>
    @endforelse
  </tbody>
</table>

{{-- 🧩 Modal Section (Pindahkan semua modal ke luar tabel) --}}
@foreach($interviews as $interview)
  <div class="modal fade" id="editInterviewModal{{ $interview->id }}" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content border-0 shadow">
        <div class="modal-header bg-primary text-white">
          <h5 class="modal-title"><i class="bi bi-pencil-square me-2"></i>Edit Interview</h5>
          ...
          <div class="modal-body">
            ...
            <div class="mb-3">
              ...
              <select name="status" class="form-select" required>
                ...
                <option value="canceled" {{ $interview->status == 'canceled' ? 'selected' : '' }}>Cancelled</option>
              </select>
            </div>
            <div class="mb-3">
              <label class="form-label">Result</label>
              <input type="text" name="result" class="form-control" value="{{ $interview->result }}" placeholder="e.g. Passed, Failed, etc.">
            </div>
          </div>
    ...
    $(document).ready(function () {
      $('#interviewsTable').DataTable({
        ...
        language: {
          ...
          zeroRecords: "No interview found",
          info: "Showing _START_ to _END_ of _TOTAL_ interviews",
          infoEmpty: "No interviews available",
